...
public:
    ...
    bool OnGossipHello(Player* player, Creature* creature)
    {
        ...
        player->ADD_GOSSIP_ITEM(TRAINER_ICON, "|cff00ff00|TInterface\\icons\\spell_chargepositive:30|t|r Learn all my spells", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+1);
        player->ADD_GOSSIP_ITEM(TRAINER_ICON, "|cff00ff00|TInterface\\icons\\spell_chargenegative:30|t|r Reset my talents", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+2);
		player->ADD_GOSSIP_ITEM(TRAINER_ICON, "|cff00ff00|TInterface\\icons\\spell_chargenegative:30|t|r Reset my pet talents", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+3);
		player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT,	 "Nevermind", GOSSIP_SENDER_MAIN, 2222);
    ...
    bool OnGossipSelect(Player* player, Creature* creature, uint32 sender, uint32 action)
    {
        if (action == GOSSIP_ACTION_INFO_DEF+2)
        {
			...
			ChatHandler(player->GetSession()).PSendSysMessage("Talents were reset.");
            return true;
        }
